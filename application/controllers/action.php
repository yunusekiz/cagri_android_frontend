...
class action extends CI_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			else // formdaki postlardan gelen datalar admin tablosuyla uyuşmuyorsa, "login_form" isimli views de hata görüntüler  
			{
				...
				echo "<meta http-equiv=\"refresh\" content=\"0; url=loginpage\">"; // hata 3 saniye sonra kaybolur, kullanıcı tekrar login formuna yönlendirilir.
			}
		}	
	}
	...
	// getAdminRow(), "admin_model" isimli model sınıfını çağırır, admin tablosundaki ilgili satırı getirir.
	protected function getAdminRow()
	{
		$this->load->model('admin_model'); // "login_model" isimli modeli çağırır.
		 
		$rowData = $this->admin_model->getAdminRow(); // "login_model" deki getAdminRow() metodunu çağırır 
