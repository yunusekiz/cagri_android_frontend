    ...
    <div class="container">
      ...
      <div class="control-group"> 
           <div class="controls">  
              ...
              <input type="text" required="true" class="input-xlarge" id="input01" name="student_number">
           </div>  
      </div>
       ...
       <div class="control-group"> 
           <div class="controls">  
              ...
              <input type="text" required="true" class="input-xlarge" id="input01" name="student_name">
           </div>  
      </div>
      ...
      <div class="control-group"> 
           <div class="controls">  
              ...
              <input type="text" required="true" class="input-xlarge" id="input01" name="student_surname">
           </div>  
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls" width="80px">
          <div class="input-prepend">
            ...
            <input class="span2" id="inputIcon" type="text" name="student_email">
          </div>
        </div>
      </div>
