...
<body>
  ...
  <div class="navbar navbar-inverse nav">
    ...
    <div class="container">
      ...
      <div class="row">
        <form class="form-signin" action="" method="" id="form">
      <fieldset>
      ...
      <div class="control-group"> 
           <div class="controls">  
              ...
              <input type="text" required="true" class="input-xlarge" id="input01" name="instructor_number">
           </div>  
      </div>
       ...
       <div class="control-group"> 
           <div class="controls">  
              ...
              <input type="text" required="true" class="input-xlarge" id="input01" name="instructor_name">
           </div>  
      </div>
      ...
      <div class="control-group"> 
           <div class="controls">  
              ...
              <input type="text" required="true" class="input-xlarge" id="input01" name="instructor_surname">
           </div>  
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls" width="80px">
          <div class="input-prepend">
            ...
            <input class="span2" id="inputIcon" type="text" name="instructor_email">
          </div>
        </div>
      </div>
          ...
          <div class="control-group"> 
           <div class="input-append date" id="dp3" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
              <input class="span2" size="16" type="text" value="12-02-2012" name="instructor_birthdate">
              <span class="add-on"><i class="icon-calendar"></i></span>
            </div>
             <div class="control-group"> 
           <div class="controls">  
              <label class="control-label" for="textarea">Password</label>
              <input type="text" required="true" class="input-xlarge" id="input01" name="instructor_password">
           </div>  
      </div>
