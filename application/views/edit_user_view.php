...
<div style="float:left; margin-left:350px; margin-right:50px;">
    <a href="edit_student" class="btn btn-primary">
        <i class="icon-pencil icon-white"></i>
        <span><strong>Edit Student</strong></span>            
    </a>
</div>


<div  style="float:left;">
    <a href="edit_instructor" class="btn btn-primary">
        <i class="icon-edit icon-white"></i>
        <span><strong>Edit Instructor</strong></span>       
    </a>  
</div>
