...
<div class="navbar navbar-inverse nav">
    ...
    <div class="container">
      <div class="row">
        <div class="well">
        <center><h1>User Addition</h1></center>
        </div>
      </div>
...
<div class="btn-group">
              <a class="btn btn-primary" href="#"><i class="icon-user icon-white"></i> Add User</a>
              <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="student"><i class="icon-plus"></i> Add New Student</a></li>
                <li><a href="instructor"><i class="icon-plus"></i> Add New Instructor</a></li>
